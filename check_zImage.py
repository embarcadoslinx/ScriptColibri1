...
def encontrar_zImage(tentativas_restantes=3):
    if tentativas_restantes == 0:
        print("Limite de tentativas ao tentar encontrar zImage. Encerrando o script.")
    ...
    if img_nosuchfileordirectory is not None:
        print("zImage encontrado e enviado!!!")
        time.sleep(2)

    else:
        print("zImage não foi encontrado.")
        time.sleep(2)
        encontrar_zImage(tentativas_restantes - 1)
